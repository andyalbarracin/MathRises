...
export const PLAYABLE: Record<string, PlayableConcept> = {
  [ENTEROS_CONCEPT_ID]: {
    ...
    templateIds: ["INTEGER_ADD", "INTEGER_SUBTRACT", "INTEGER_MULT", "INTEGER_TRIPLE", "INTEGER_COMPARE"],
    tone: "blue",
    icon: Calculator,
  },
  [ORDEN_CONCEPT_ID]: {
    ...
    lesson: ordenLesson,
    templateIds: ["ORDER_BASIC", "ORDER_DIVISION", "ORDER_PAREN", "ORDER_TWO_OPS", "ORDER_STEP"],
    tone: "amber",
    icon: ListOrdered,
  },
  [FRACCIONES_CONCEPT_ID]: {
    ...
    templateIds: ["FRACTION_SIMPLIFY", "FRACTION_ADD", "FRACTION_SUBTRACT", "FRACTION_MULTIPLY", "FRACTION_EQUIVALENCE", "FRACTION_ERROR_SPOTTING"],
    tone: "violet",
    icon: Divide,
  },
  [POTENCIAS_CONCEPT_ID]: {
    ...
    templateIds: ["POWER_EVAL", "ROOT_EVAL", "POWER_NEG_BASE", "POWER_PRODUCT"],
    tone: "coral",
    icon: Superscript,
  },
