...
export const ROADMAP: RoadmapSection[] = [
  ...
  },
  {
    ...
    nodes: [
      ...
      { conceptId: "polinomios", title: "Operaciones con polinomios", targetWeek: 4, playable: false },
      { conceptId: "factorizacion-1", title: "Factorización I", targetWeek: 5, playable: false },
  ...
  },
  {
    ...
    nodes: [
      ...
      { conceptId: "ecuaciones-cuadraticas", title: "Cuadráticas y valor absoluto", targetWeek: 8, playable: false },
